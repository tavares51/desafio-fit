...
def test_crud_books_admin(client):
    ...
    # create
    r1 = client.post("/books", json={"title": "Clean Code", "author": "Robert Martin", "year": 2008}, headers=headers)
    ...
    # patch
    r4 = client.patch(f"/books/{book_id}", json={"year": 2009}, headers=headers)
    assert r4.status_code == 200
    assert r4.json["year"] == 2009
